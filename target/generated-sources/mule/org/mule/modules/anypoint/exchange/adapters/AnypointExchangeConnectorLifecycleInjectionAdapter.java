...
/**
 * A <code>AnypointExchangeConnectorLifecycleInjectionAdapter</code> is a wrapper around {@link AnypointExchangeConnector } that adds lifecycle methods to the pojo. This adapter also allows the injection of several Mule facilities when a MuleContext is set.
 * 
 */
@SuppressWarnings("all")
@Generated(value = "Mule DevKit Version 3.7.1", date = "2015-12-06T10:38:20-03:00", comments = "Build UNNAMED.2613.77421cc")
public class AnypointExchangeConnectorLifecycleInjectionAdapter
    extends AnypointExchangeConnectorMetadataAdapter
    implements MuleContextAware, Disposable, Initialisable, Startable, Stoppable
{
    ...
    {
        Logger log = LoggerFactory.getLogger(AnypointExchangeConnectorLifecycleInjectionAdapter.class);
